...
const App: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen pb-32 transition-colors duration-700 ${isDemoMode ? 'bg-[#020617]' : 'bg-[#02040a]'}`}>
        ...
        <div className="max-w-7xl mx-auto px-8 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <button 
              ...
              className={`px-12 py-5 text-slate-950 text-sm font-black rounded-[2rem] transition-all flex items-center gap-4 active:scale-95 group relative overflow-hidden shadow-2xl ${isDemoMode ? 'bg-blue-500 hover:bg-blue-400 shadow-blue-500/40' : 'bg-emerald-500 hover:bg-emerald-400 shadow-emerald-500/40'}`}
            >
              <span className="relative z-10">🚀 {isDemoMode ? 'TEST ON DEMO' : 'DEPLOY v5.5 FINAL'}</span>
